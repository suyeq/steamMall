		...
		function createNewSlider(element, options) {
			...
			**************************************************/
			...
			if (this.sliderElem) {
				...
				sliderMinHandle.className = "slider-handle dropzone-slider-handle";
				...
				sliderTooltipMin.className = "tooltip tooltip-dropzone";
			...
			**************************************************/
			...
			this.tooltip_min = this.sliderElem.querySelector('.tooltip-dropzone');
		...
		Slider.prototype = {
			...
			********************************/
			...
			_keydown: function(handleIdx, ev) {
				...
				// use natural arrow keys instead of from dropzone to max
...
! (function(factory) {
	...
	var Datetimepicker = function(element, options) {
		...
		if ('minView' in options) {
			...
			this.minView = this.element.data('dropzone-view');
		}
